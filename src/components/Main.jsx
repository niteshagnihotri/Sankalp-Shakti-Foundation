...
export default function Main() {
    ...
    return (
        <div className="relative scroll-smooth">
            ...
            <motion.div initial={{y: 50, opacity:0}} whileInView={ {y: 0, opacity:1} } transition={{ delay: 0.3 }} className="absolute right-0 left-0 bottom-0 top-[40%] text-center space-y-5 md:space-y-10 my-auto text-white font-bold z-50">
