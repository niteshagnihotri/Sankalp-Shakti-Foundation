    ...
    return (
        <div className="w-100 font-semibold pb-10">
            <div className="md:w-9/12 md:mx-auto">
                ...
                <div>
                    <motion.h3 initial={{ opacity:0}} whileInView={ { opacity:1} } transition={{ delay: 0.3 }} viewport={{ once: true }} className="leading-loose px-8 tracking-wider text-xl md:text-lg text-justify">
